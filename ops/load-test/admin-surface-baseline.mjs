const adminBase = process.env.ADMIN_BASE || "http://localhost:3101";
const totalRequests = Number(process.env.LOAD_REQUESTS || 24);
...
const scenarios = [
  { name: "dashboard", url: `${adminBase}/dashboard`, expectedStatus: 200, p95Limit: 3000 },
  { name: "product-list", url: `${adminBase}/product-list`, expectedStatus: 200, p95Limit: 3000 },
  { name: "orders", url: `${adminBase}/orders`, expectedStatus: 200, p95Limit: 3000 },
  { name: "reviews", url: `${adminBase}/reviews`, expectedStatus: 200, p95Limit: 3000 },
  { name: "coupon", url: `${adminBase}/coupon`, expectedStatus: 200, p95Limit: 3000 },
  { name: "returns", url: `${adminBase}/returns`, expectedStatus: 200, p95Limit: 3000 },
];
