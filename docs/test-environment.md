...
- `harri-front-end/tests/test-env/shop-smoke.mjs`
  - Çoklu marka, özel fiyat aralığı, boş sonuç ekranı ve mobil filtre drawer akışlarını browser seviyesinde smoke test eder.
...
- Bu katman yalnızca public storefront yüzeyi için kuruldu.
- Bir sonraki adımda aynı yaklaşım admin panel listeleri ve sipariş/review akışları için genişletilebilir.
