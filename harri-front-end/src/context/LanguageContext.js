...
const translations = {
  tr: {
    ...
    couponCodeRequired: "Lütfen bir kupon kodu girin.",
    couponInvalid: "Geçerli bir kupon kodu girin.",
    couponExpired: "Bu kupon artık geçerli değil.",
    couponMinimumAmount: "Bu kupon için minimum tutar:",
    couponAppliedSuccess: "kuponu başarıyla uygulandı.",
    shippingOptionRequired: "Lütfen bir kargo seçeneği seçin.",
    orderCreateFailed: "Sipariş oluşturulurken bir hata oluştu.",
    orderCreateSuccess: "Siparişiniz başarıyla alındı!",
  ...
  en: {
    ...
    couponInvalid: "Please enter a valid coupon code.",
    couponExpired: "This coupon is no longer valid.",
    couponMinimumAmount: "Minimum amount required for this coupon:",
    couponAppliedSuccess: "coupon has been applied successfully.",
    shippingOptionRequired: "Please select a shipping option.",
    orderCreateFailed: "There was an error while creating your order.",
    orderCreateSuccess: "Your order has been received successfully!",
    goToShop: "Go to Shop",
