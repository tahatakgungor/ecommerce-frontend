...
const translations = {
  tr: {
    ...
    shareOnWhatsApp: "WhatsApp ile Paylaş",
    shareWithEmail: "E-posta ile Paylaş",
    ...
    clearCartConfirm: "Sepetteki tüm ürünler silinsin mi?",
    clearCartSuccess: "Sepet tamamen boşaltıldı.",
    couponCodePlaceholder: "Kupon kodunu girin",
    applyCoupon: "Kuponu Uygula",
    couponApplied: "Kupon uygulandı",
    appliedCouponLabel: "Uygulanan kupon",
    ...
    couponLoginRequired: "Kupon kullanmak için giriş yapmalısınız.",
    couponReservedUntilOrder: "Bu kupon siparişi tamamlayana kadar hesabınızda aktif kalır.",
    ...
    reviewProducts: "Ürünleri Değerlendir",
    logout: "Çıkış Yap",
    ...
    statusCancel: "İptal",
    statusReturnRequested: "İade Talep Edildi",
    statusReturnApproved: "İade Onaylandı",
    statusReturnRejected: "İade Reddedildi",
    statusReturnReceived: "İade Alındı",
    statusReturnRefunded: "İade Edildi",
    returnRequest: "İade Talebi",
    requestReturn: "İade Talebi Oluştur",
    returnReason: "İade Nedeni",
    returnReasonSelect: "Neden seçin",
    returnReasonDamaged: "Hasarlı / Bozuk Ürün",
    returnReasonWrongItem: "Yanlış Ürün Gönderildi",
    returnReasonSizeIssue: "Beden / Ölçü Uyumsuzluğu",
    returnReasonChangedMind: "Fikir Değişikliği",
    returnReasonQuality: "Kalite Beklentiyi Karşılamadı",
    returnReasonOther: "Diğer",
    returnNote: "Ek Not (opsiyonel)",
    returnNotePlaceholder: "Detaylı açıklama ekleyebilirsiniz...",
    submitReturn: "İade Talebi Gönder",
    returnStatusLabel: "İade Durumu",
    returnWindowExpired: "İade süresi dolmuş.",
    returnAlreadyExists: "Bu sipariş için açık bir iade talebi zaten mevcut.",
    returnSuccess: "İade talebiniz başarıyla oluşturuldu.",
  ...
  en: {
    ...
    clearCartSuccess: "Cart has been emptied.",
    ...
    couponLoginRequired: "You need to sign in to use a coupon.",
    couponReservedUntilOrder: "This coupon will stay active on your account until you complete the order.",
    ...
    statusReturnReceived: "Return Received",
    statusReturnRefunded: "Refunded",
    returnRequest: "Return Request",
    requestReturn: "Request Return",
    returnReason: "Return Reason",
    returnReasonSelect: "Select a reason",
    returnReasonDamaged: "Damaged / Defective Product",
    returnReasonWrongItem: "Wrong Item Received",
    returnReasonSizeIssue: "Size / Fit Issue",
    returnReasonChangedMind: "Changed My Mind",
    returnReasonQuality: "Quality Did Not Meet Expectations",
    returnReasonOther: "Other",
    returnNote: "Additional Note (optional)",
    returnNotePlaceholder: "You can add a detailed description...",
    submitReturn: "Submit Return Request",
    returnStatusLabel: "Return Status",
    returnWindowExpired: "Return window has expired.",
    returnAlreadyExists: "An open return request already exists for this order.",
    returnSuccess: "Your return request was submitted successfully.",
