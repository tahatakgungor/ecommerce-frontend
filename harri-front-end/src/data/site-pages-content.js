export const sitePagesContent = {
  ...
  en: {
    faq: {
      ...
      tabs: [
              ...
              accordions: [
                {
                  ...
                  desc: "Confirmed orders are usually prepared within 1-3 business days. During campaign periods, preparation may take slightly longer depending on volume.",
                },
                {
                  id: "general-two",
                  title: "How can I track my shipment?",
                  desc: "Once your order is handed over to the carrier, we send a notification to your email address. You can then follow the shipment with the tracking number.",
                },
                {
                  id: "general-three",
                  title: "Can I purchase multiple products in one order?",
                  desc: "Yes. You can add products from different categories to your cart and complete checkout in a single order as long as stock is available.",
                },
              ],
            },
            {
              ...
              accordions: [
                {
                  id: "general-four",
                  title: "Where can I find product details and usage information?",
                  desc: "Each product page includes core content, usage guidance, and important notes. For special situations, we recommend reviewing the product label and consulting a professional if needed.",
                },
                {
                  id: "general-five",
                  title: "What happens if a product is out of stock?",
                  desc: "Out-of-stock items are not kept open for checkout. When stock is replenished, the product page will show the purchase option again.",
                },
              ],
            },
          ],
          ...
          sections: [
            {
              ...
              accordions: [
                ...
                {
                  id: "support-two",
                  title: "Why is a coupon visible only on my account?",
                  desc: "Some campaigns are assigned to specific customers. This is a common e-commerce approach for personalized offers and for limiting abuse.",
                },
                {
                  id: "support-three",
        ...
        },
        {
          ...
          sections: [
            {
              title: "Membership and After-Sales",
              accordions: [
                {
                  id: "account-one",
                  title: "Where can I update my account details?",
                  desc: "You can manage your delivery addresses, contact details, and account information from the profile area.",
                },
                {
                  id: "account-two",
    ...
    policy: {
      ...
      contactIntro: "If you have questions about privacy or the processing of your data, you can reach us using the details below.",
      contactEmail: "destek@serravit.com",
      contactAddress: ["Serravit Natural Wellness Products", "Turkiye"],
    },
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "You are responsible for keeping your account information accurate and for activity performed through your account.",
            "Site design, copy, visuals, and brand assets are protected under applicable intellectual property rights.",
          ],
        },
      ],
      contactTitle: "Contact",
      contactIntro: "If you have any questions about these terms, our support team can help.",
      contactEmail: "destek@serravit.com",
      contactAddress: ["Serravit Natural Wellness Products", "Turkiye"],
    },
  },
