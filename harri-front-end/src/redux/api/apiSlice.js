...
export const apiSlice = createApi({
  ...
  tagTypes: ["Category", "Products", "Discount", "Coupon", "Product", "RelatedProducts", "ProductReviews", "ProductReviewSummary", "ProductReviewEligibility", "MyReviewOverview", "Banners"],
  endpoints: (builder) => ({}),
});
